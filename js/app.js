(() => {
    ...
    da.init();
    const script_all = document.querySelector("#all");
    const art = document.querySelector("#art");
    const culture = document.querySelector("#culture");
    const design = document.querySelector("#design");
    art.addEventListener("click", hide);
    culture.addEventListener("click", hide);
    design.addEventListener("click", hide);
    script_all.addEventListener("click", allHide);
    function hide() {
        script_all.checked = false;
    }
    function allHide() {
        art.checked = false;
